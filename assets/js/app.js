...
/**Pintar valores de atención */
radiologiahtml.textContent = `Primera atención: ${radiologia[0].paciente} - ${radiologia[0]["prevision"]} 
| Última atención: ${radiologia[radiologia.length - 1].paciente} - ${radiologia[radiologia.length - 1].prevision}`

traumatologiahtml.textContent = `Primera atención: ${traumatologia[0].paciente} - ${traumatologia[0]["prevision"]} 
| Última atención: ${traumatologia[traumatologia.length - 1].paciente} - ${traumatologia[traumatologia.length - 1].prevision}`

dentalhtml.textContent = `Primera atención: ${dental[0].paciente} - ${dental[0]["prevision"]} 
| Última atención: ${dental[dental.length - 1].paciente} - ${dental[dental.length - 1].prevision}`


/**Recorrer Arreglos e insertar en tabla */
